...
def testimage():
    if request.method == 'POST':
        ...
        resu=process_image(src, out)

        return render_template('testimage.html',result=resu, inputimage=src, outputimage=out)
    return render_template('testimage.html')
...
def testvideo():
    if request.method == 'POST':
        ...
        res=process_video(src, out)

        return render_template('testvideo.html',result=res, inputvideo=src, outputvideo=out)
